...
import { X, Gem, CheckCircle2, Upload, Loader2, AlertCircle, QrCode, CreditCard } from 'lucide-react';
...
const ProUpgradeModal: React.FC<ProUpgradeModalProps> = ({ user, config, onClose }) => {
      ...
      <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50 p-6">
        <div className="bg-neutral-900 border border-neutral-800 rounded-3xl p-8 max-w-md w-full text-center">
          ...
          <p className="text-neutral-400 mb-8">
            Our team will review your payment screenshot and upgrade your account within 24 hours.
          </p>
          <button 
            onClick={onClose}
      ...
      <div className="bg-neutral-900 border border-neutral-800 rounded-[2.5rem] w-full max-w-4xl overflow-hidden shadow-2xl my-auto">
        <div className="p-6 border-b border-neutral-800 flex justify-between items-center bg-neutral-900/50">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-xl font-black tracking-tighter">UPGRADE TO <span className="text-orange-500">PRO</span></h2>
          </div>
        ...
        <div className="p-8 grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div className="space-y-8">
            <div>
              ...
              <ul className="space-y-4">
                {[
                  ...
                  "Advanced AI Models (Gemini 3.1)",
                  "Style Reference Engine",
            ...
            <div className="p-6 bg-gradient-to-br from-orange-500 to-red-600 rounded-3xl shadow-xl shadow-orange-500/20">
              <p className="text-white/80 text-[10px] font-bold uppercase tracking-widest mb-1">Monthly Subscription</p>
              <p className="text-4xl font-black text-white tracking-tighter">NPR 1999/-</p>
              <p className="text-white/60 text-[10px] mt-2 font-medium">Per month. Cancel anytime.</p>
            </div>
          </div>
